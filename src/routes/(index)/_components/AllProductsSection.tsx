...
export default function AllProductsSection() {
  ...
  return (
    <div className='py-10 px-6 bg-gradient-to-br from-gray-900 via-blue-950/20 to-gray-900 border-l-4 border-blue-500/70'>
      <div className='flex gap-4 flex-col'>
        <div className='flex justify-between items-center'>
          ...
          <div className='flex items-center'>
            <Button
              variant='ghost'
              className='cursor-pointer text-gray-300 hover:text-blue-400 hover:bg-gray-800'
        ...
        <div className='relative px-12'>
          ...
          >
            ...
            <CarouselPrevious className='hidden sm:flex absolute -left-10 top-1/2 -translate-y-1/2 z-10 border-gray-600 text-gray-300 hover:bg-gray-800 hover:text-blue-400' />
            <CarouselNext className='hidden sm:flex absolute -right-10 top-1/2 -translate-y-1/2 z-10 border-gray-600 text-gray-300 hover:bg-gray-800 hover:text-blue-400' />
          </Carousel>
        </div>
      </div>
    </div>
